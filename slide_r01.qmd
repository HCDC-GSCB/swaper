...
**Đoạn code (code chunks)**: là nơi để viết code và xuất ra các kết quả mong muốn. Code chunks của R được đặt trong cặp dấu: ![](rmarkdown.png)
...
-   Ví dụ có file R Markdown sau: ![](rmd.png)
...
-   Để knit file R Markdown thì chọn kí hiệu knit trên thanh công cụ: ![](rmd-add-chunk.png)
