...
| Lệnh           | Mô tả                                                                                     | GIF                 |
+================+===========================================================================================+=====================+
| `left_join()`  | Lấy bảng bên trái làm tham chiếu và tìm kiếm các hàng tương ứng của bảng bên phải để nối. | ![](left-join.gif)  |
|                |                                                                                           |                     |
|                | Nếu các hàng không có hàng tương ứng để nối, trả về giá trị **NA**                        |                     |
+----------------+-------------------------------------------------------------------------------------------+---------------------+
| `inner_join()` | Lấy bảng bên trái làm tham chiếu và tìm kiếm các hàng tương ứng của bảng bên phải để nối. | ![](inner-join.gif) |
|                |                                                                                           |                     |
|                | Các hàng không có hàng tương ứng để nối **sẽ bị xóa**                                     |                     |
+----------------+-------------------------------------------------------------------------------------------+---------------------+
| `full_join()`  | Giữ lại tất cả các hàng của 2 bảng sau khi nối                                            | ![](full-join.gif)  |
|                |                                                                                           |                     |
