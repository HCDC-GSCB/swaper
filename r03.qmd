...
::: center-text
[🚀 Presentation](slide_r03.html){.btn .btn-outline-secondary style="border-radius: 12px;"}[📎 simulated_covid](data/simulated_covid.rds){.btn .btn-outline-secondary style="border-radius: 12px;"} [📎 cleaned_vacdata](data/cleaned_vacdata.rds){.btn .btn-outline-secondary style="border-radius: 12px;"}
:::
