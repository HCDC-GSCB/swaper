---
title: "Tổng quan về R"
author: Thu Pham
date: 2025-7-02
image: picture/icon-cat.png
categories: [Overview, R]
description: "R là một ngôn ngữ lập trình, không phải phần mềm"
---
...
![](../../picture/webr.png){fig-align="center"}
...
![](../../picture/RStudio.png){fig-align="center"}
...
## GitHub Desktop ![](../../picture/GitHubDesktop.png){width="27"}
...
::: {.column width="50%"}
![](../../picture/Picture2.png){width="100%"}
:::
:::::
...
**Đoạn code (code chunks)**: là nơi để viết code và xuất ra các kết quả mong muốn. Code chunks của R được đặt trong cặp dấu: ![](../../picture/rmarkdown.png)

## R Markdown

-   Để tạo code chunk chúng ta nhấn tổ hợp phím tắt `Ctrl + Alt + I`, hoặc nhấn vào icon này trên thanh công cụ, chọn R: ![](../../picture/rmd-add-chunk.png)

-   Ví dụ có file R Markdown sau: ![](../../picture/rmd.png)
...
-   Để knit file R Markdown thì chọn kí hiệu knit trên thanh công cụ: ![](../../picture/rmd-add-chunk.png)

![](../../picture/rmd-outp.png)

## R Markdown

![](../../picture/intro-rmd-1.png)

## R Markdown

![](../../picture/intro-rmd-2.png)

## R Markdown

![](../../picture/intro-rmd-3.png)

## R Markdown

![](../../picture/intro-rmd-4.png)

![](../../picture/intro-rmd-5.png)
