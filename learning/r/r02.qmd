---
title: "Làm sạch và xử lý dữ liệu với R"
author: Anh Huynh, Thu Pham
date: 2025-7-02
image: picture/tidyr.png
categories: [Cleaning, Analysis, R]
description: "Làm sạch và xử lý dữ liệu phải là 1 quy trình, đây là một bước chuẩn bị chi tiết cho phân tích dữ liệu"
---
...
```{r}
#| echo: false
dff <- readRDS("../../data/covid_cases.rds")
head(dff[, 1:6], 3)
```
...
+----------------+-------------------------------------------------------------------------------------------+----------------------------------------------------------------+
| # Lệnh         | # Mô tả                                                                                   | GIF \| =====================+ ![](../../picture/left-join.gif) \| \| |
|                |                                                                                           |                                                                |
